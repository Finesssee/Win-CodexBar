...
if ($expectedPnpm -notmatch '^11\.25\.0$') {
    throw "Unexpected packageManager '$($packageJson.packageManager)'; release pipeline pins pnpm 11.25.0."
}
...
Write-Host ''
Write-Host "Release prerequisites passed (Git, Node $requiredNodeMajor, pnpm 11.25.0, Rust MSVC target, Inno Setup 6)."
